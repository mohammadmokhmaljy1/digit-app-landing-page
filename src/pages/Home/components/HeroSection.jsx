...
const HeroSection = () => {
    return (
        <>
        <div className='min-h-screen flex justify-evenly items-center p-10 flex-wrap gap-10 pt-20'>
            <div className="text max-w-md">
                ...
                <div>
                    <a href="/services/" className='btn ml-2 mb-2'> عرض الخدمات</a>
                    <a href="/contact/" className='btn btn-reverse'> تواصل معنا</a>
                </div>
            </div>
